...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $total_pending_posts = Post::where('status',Post::STATUS_PENDING)->count();
        $total_expire_posts = Post::where('status',Post::STATUS_EXPIRE)->count();
        ...
        return view('admin.dashboard.index', compact(
            'total_posts','total_pending_posts','total_expire_posts',
            'total_earnings',
            'total_users',
            'current_month_posts',
