...
@section('title', ___('Regions in '. $country->name))
@section('header_buttons')
    <a href="#" data-url="{{ route('admin.regions.create',['countryCode' => $country->code]) }}" data-toggle="slidePanel" class="btn btn-primary ms-2"><i class="icon-feather-plus me-2"></i> {{ ___('Add New') }}</a>
@endsection
@section('content')
    ...
    <div class="quick-card card">
        <div class="card-body">
            <div class="dataTables_wrapper">
                <table class="table table-striped" id="ajax_datatable" data-jsonfile="{{ route('admin.countries.regions.index', ['countryCode' => $country->code]) }}">
                    <thead>
                    <tr>
                        <th data-priority="1">#</th>
                        <th>{{ ___('Region Name') }}</th>
                        <th>{{ ___('Status') }}</th>
    ...
    <div class="site-action">
        <div class="site-action-buttons">
            <button type="button" id="quick-delete-button" data-action="{{ route('admin.regions.delete') }}"
        ...
        <button type="button" class="front-icon btn btn-primary btn-floating"
                data-url="{{ route('admin.regions.create',['country' => $country, 'countryCode' => $country->code]) }}" data-toggle="slidePanel">
