                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2 pb-1">
                        <div class="avatar me-2">
                            <span class="avatar-initial rounded bg-label-primary"><i class="icon-feather-layers"></i></span>
                        </div>
                        <h4 class="ms-1 mb-0">{{ format_number_count($total_posts) }}</h4>
                    </div>
                    <p class="mb-0 fs-6">{{ ___('Total Listings') }}</p>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-lg-3">
            <div class="card card-border-shadow-danger">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2 pb-1">
                        <div class="avatar me-2">
                            <span class="avatar-initial rounded bg-label-danger"><i class="icon-feather-layers"></i></span>
                        </div>
                        <h4 class="ms-1 mb-0">{{ format_number_count($total_expire_posts) }}</h4>
                    </div>
                    <p class="mb-0 fs-6">{{ ___('Total Expired Listings') }}</p>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-lg-3">
            <div class="card card-border-shadow-warning">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2 pb-1">
                        ...
                        <h4 class="ms-1 mb-0">{{ format_number_count($total_pending_posts) }}</h4>
                    </div>
                    <p class="mb-0 fs-6">{{ ___('Total Pending Listings') }}</p>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-lg-3">
            <div class="card card-border-shadow-info">
                <div class="card-body">
                    ...
                    <p class="mb-0 fs-6">{{ ___('Current Month Listings') }}</p>
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-lg-3">
