                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-6 footer-copyright">
                                <p class="mb-0">{{___('Copyright')}} © {{date("Y")}} <a href="https://balotraweddinghub.com" target="_blank">Balotra Wedding Hub</a>. {{___('All rights reserved.')}} </p>
                            </div>
                            <div class="col-md-6">
                                <p class="float-end mb-0">{{___('Designed & Devveloped by')}} <a href="https://softieons.com" target="_blank">Softieons</a></p>
                            </div>
                        </div>
                    </div>
                </footer>
