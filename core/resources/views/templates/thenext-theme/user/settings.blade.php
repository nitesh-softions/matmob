                        ...
                        <div class="submit-field">
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="BrowseButton">
                                    <input class="BrowseButton-input" type="file" accept="image/jpg, image/jpeg, image/png" id="upload" name="avatar" onchange="readImageURL(this, 'avatar-img');"/>
                                    <label class="BrowseButton-button ripple-effect" for="upload">{{ ___('Upload Avatar') }}</label>
                                    <span class="BrowseButton-file-name">{{ ___('Use 150x150px for better use') }}</span>
                                </div>
                            </div>
        ...
        <div class="content">
            <div class="content with-padding">
                ...
                <form method="post" action="{{ route('settings.editBilling') }}" accept-charset="UTF-8">
                    ...
                    <div class="submit-field select-wrapper">
                        <h5>{{ ___('Country') }} *</h5>
