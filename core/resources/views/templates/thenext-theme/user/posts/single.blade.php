...
@section('content')
    ...
    <div class="container">
        ...
        <div class="product-compare-btn-container">
            <a class="button ripple-effect product-compare-btn margin-top-20" href="{{ url('ad', [$post->id, $post->title]) }}"  data-category_id="{{ $post->category_id }}" data-post_id="{{ $post->id }}" data-post_title="{{ $post->title }}" data-post_image="{{ $postImage }}" onclick="addCompareProduct(this, event)"><i class="icon-feather-repeat margin-right-5"></i>Compare</a>
        </div>
        ...
        <div class="row margin-top-20">
            ...
            <div class="col-xl-8 col-lg-8 content-right-offset">
                <div class="single-page-section job-detail-box">
                    <h3  class="mb-0 job-detail-box-headline">{{ ___('Details') }}</h3>
                    <div class="row g-2 job-detail-box-inner text-start">
                        <div class="col-md-6">
