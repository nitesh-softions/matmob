                    ...
                    <div class="margin-top-20 margin-bottom-30">
                        ...
                        <div>
                            ...
                            <input type="text" class="with-border"
                                   placeholder="{{ ___('Name') }}" value="{{ @$user_options->billing_name }}"
                                   readonly disabled>
                        </div>
                        <div>
                        ...
                        <div class="submit-field">
                            <label class="form-label">{{ ___('Country') }} <span
                                    class="required">*</span></label>
                            <select name="country" class="with-border selectpicker" data-live-search="true" data-size="5" required>
                    ...
                    @if($price > 0)
                        ...
                        <div class="payment margin-top-30">
                            @forelse ($paymentGateways as $paymentGateway)
                                <div class="payment-tab @if($loop->first) payment-tab-active @endif">
                                    <div class="payment-tab-trigger">
                                        <input name="payment_method" id="{{ $paymentGateway->payment_folder }}"
                                               type="radio" value="{{ $paymentGateway->id }}"
                                               data-name="{{ $paymentGateway->payment_folder }}" @checked($loop->first)>
                                        <label
                                                ...
                                                <table class="default-table table-alt-row PaymentMethod-infoTable">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <span
                                                                class="PaymentMethod-info">{{ nl2br(@$settings->company_bank_info) }}</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
